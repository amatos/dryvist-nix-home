...
| Repo | Purpose |
|------|---------|
| [nix-ai](https://github.com/amatos/dryvist-nix-ai) | AI coding tools (Claude, Gemini, Copilot) |
...
| [nix-darwin](https://github.com/amatos/dryvist-nix-darwin) | macOS system config (consumes nix-ai + nix-home) |
